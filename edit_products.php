...
<head>
   ...
   <title>supergroceries website editing menu</title>
     <link type="text/css" rel="stylesheet" href="../SOEN287/nagan final page bacekend/nagan final page/mainstyle.css">
   <link type="text/css" rel="stylesheet" href="../SOEN287/nagan final page bacekend/nagan final page/Liststyle.css">
   <link type="text/css" rel="stylesheet" href="../SOEN287/nagan final page bacekend/nagan final page/styles.css">
   ...
   <div class="main_conntainer">
    ...
    if(isset($_POST['submit_Changes'])){
        $xml1=simplexml_load_file("products.xml") or die("Error: Cannot create object"); 
            ...
            echo"<h2>Changes have been submitted</h2>";
            }
        }
    }
